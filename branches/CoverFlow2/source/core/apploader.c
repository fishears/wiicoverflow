...
// Thanks to e.bovendeur 
void PretendDiscInserted(void *buffer, u32 len)
{
...
/** Thanks to WiiPower **/
bool NSMB_Patch(void *Address, int Size)
{
	if (memcmp("SMNE", (char *)0x80000000, 4) == 0)  // NTSC
	{
	...
	else if (memcmp("SMN", (char *)0x80000000, 3) == 0) // PAL
	{
