...
INCLUDES	:=	source source/libwbfs include include/pngu include/core
...
LIBS	:=	 -lfat -lntfs -ltremor -lfreetype -lwiiuse -lbte -lasnd -lpng -lz -logc -lm -lmxml -lwiikeyboard
#---------------------------------------------------------------------------------
# list of directories containing libraries, this must be the top level containing
# include and lib
#---------------------------------------------------------------------------------
LIBDIRS	:= $(DEVKITPPC)/lib $(PORTLIBS) $(CURDIR) $(CURDIR)/libs/libfat $(CURDIR)/libs/libntfs
#---------------------------------------------------------------------------------
